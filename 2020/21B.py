...
for allergen, ingredient in sorted(ingredients_for_allergens.items(), key = lambda item: item[0]):
    print(allergen, "is in", ingredient)
    canonical_dangerous_ingredients_list.append(ingredient)

print("answer:", ','.join(canonical_dangerous_ingredients_list))
